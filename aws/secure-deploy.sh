...
# Secure AWS Deployment Script for EdenOS MCP Bridge
# This script deploys without exposing credentials
...
check_aws_credentials() {
    ...
    print_status "User: $AWS_USER_ARN"
}
...
main() {
    print_status "Starting secure EdenOS MCP Bridge deployment to AWS..."
